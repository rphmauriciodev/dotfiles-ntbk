...
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen())	    -- tela cheia
...
hl.bind(
    mainMod .. " + F1",
    hl.dsp.exec_cmd("bash -c 'pgrep -x waybar >/dev/null && pkill -x waybar || waybar &'")
)
...
for i = 1, 10 do
    local monitor = (i % 2 == 0) and "HDMI-A-1" or "DP-3"
    local default = (i == 1 or i == 2) and true or false
